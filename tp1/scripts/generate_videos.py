"""Generate the six algorithm/heuristic MP4 variants for one level."""
...
CASES = (
    ("bfs", None, "bfs.mp4"),
    ("dfs", None, "dfs.mp4"),
    ("greedy", "minimum_matching_manhattan", "greedy_mmm.mp4"),
    ("greedy", "shortest_push_access", "greedy_spa.mp4"),
    ("astar", "shortest_push_access", "astar_spa.mp4"),
    ("astar", "minimum_matching_manhattan", "astar_mmm.mp4"),
)


def main(argv: Optional[Sequence[str]] = None) -> int:
    parser = argparse.ArgumentParser(
        description="Generate all six Sokoban solution MP4 variants."
    )
