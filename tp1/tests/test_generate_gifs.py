...
from scripts.generate_gifs import CASES, generate_all_gifs


class GenerateGifsScriptTest(unittest.TestCase):
    def test_runs_six_cases_and_restores_exact_original_config(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            output_dir = temporary_directory / "gifs"
