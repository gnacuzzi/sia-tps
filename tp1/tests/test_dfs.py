...
class DepthFirstSearchTest(unittest.TestCase):
    def test_solve_minimal_level_with_a_valid_path(self) -> None:
        level, initial = parse_level("levels/level_01.txt")

        result = depth_first_search(level, initial)
    ...
    def test_up_is_explored_first_when_several_moves_are_available(self) -> None:
        level, initial = self._parse_text(
            "#####\n#_.##\n#_$##\n#_@_#\n#####\n"
        )
